                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="title" name="title" value="{{ $post->title }}" placeholder="@lang('admin.title')">
                                                @error('title')
                                                    <small class="text-danger">
                                                        <b>{{ $message }}</b>
                                                    </small>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control editor" rows="4" id="text" name="text" placeholder="@lang('admin.text')">{{ $post->text }}</textarea>
                                                @error('text')
                                                    <small class="text-danger">
                                                        <b>{{ $message }}</b>
                                                    </small>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="description" name="description" value="{{ $post->description }}" placeholder="@lang('admin.meta-description')">
                                                @error('description')
                                                    <small class="text-danger">
                                                        <b>{{ $message }}</b>
                                                    </small>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="keywords" name="keywords" value="{{ $post->keywords }}" placeholder="@lang('admin.meta-keywords')">
                                                @error('keywords')
                                                    <small class="text-danger">
                                                        <b>{{ $message }}</b>
                                                    </small>
